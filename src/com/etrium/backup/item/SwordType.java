...
public class SwordType implements WeaponTypeInterface
{
    private final int SWORDTYPES = 7;
    ...
    public void Create()
    {
        int spriteNum = randomGenerator.nextInt(SWORDTYPES)+1;
        iconName = "weapons/sword0"+spriteNum;
